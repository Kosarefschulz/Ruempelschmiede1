...
const bielefeldRegionCities = [
  { name: 'Gütersloh', folder: 'guetersloh', price1: 700, price2: 1400, price3: 2080, customers: 800, slogan: 'Zuverlässig und fair!', kellerPrice: 420, distance: '17 km von Bielefeld' },
  { name: 'Herford', folder: 'herford', price1: 680, price2: 1360, price3: 2020, customers: 600, slogan: 'Hansestadt-Service!', kellerPrice: 410, distance: '13 km von Bielefeld' },
  { name: 'Paderborn', folder: 'paderborn', price1: 720, price2: 1430, price3: 2130, customers: 900, slogan: 'Universitätsstadt-Qualität!', kellerPrice: 430, distance: '38 km von Bielefeld' },
  { name: 'Bad Salzuflen', folder: 'bad-salzuflen', price1: 690, price2: 1380, price3: 2050, customers: 500, slogan: 'Kurstadt-Service!', kellerPrice: 415, distance: '16 km von Bielefeld' },
  { name: 'Osnabrück', folder: 'osnabrueck', price1: 710, price2: 1410, price3: 2110, customers: 1100, slogan: 'Friedensstadt-Power!', kellerPrice: 425, distance: '43 km von Bielefeld' },
  { name: 'Steinhagen', folder: 'steinhagen', price1: 660, price2: 1320, price3: 1980, customers: 300, slogan: 'Schnell und nah!', kellerPrice: 395, distance: '9 km von Bielefeld' },
  { name: 'Spenge', folder: 'spenge', price1: 670, price2: 1340, price3: 2000, customers: 350, slogan: 'Kompakt und effizient!', kellerPrice: 400, distance: '13 km von Bielefeld' },
  { name: 'Halle (Westfalen)', folder: 'halle-westfalen', price1: 675, price2: 1350, price3: 2010, customers: 400, slogan: 'Westfälisch gründlich!', kellerPrice: 405, distance: '12 km von Bielefeld' },
  { name: 'Lage', folder: 'lage', price1: 685, price2: 1370, price3: 2040, customers: 450, slogan: 'Lippische Qualität!', kellerPrice: 410, distance: '19 km von Bielefeld' },
  { name: 'Melle', folder: 'melle', price1: 695, price2: 1390, price3: 2070, customers: 550, slogan: 'Grenzüberschreitend gut!', kellerPrice: 418, distance: '23 km von Bielefeld' },
  { name: 'Detmold', folder: 'detmold', price1: 705, price2: 1405, price3: 2100, customers: 700, slogan: 'Residenzstadt-Service!', kellerPrice: 422, distance: '25 km von Bielefeld' },
  { name: 'Lemgo', folder: 'lemgo', price1: 685, price2: 1370, price3: 2040, customers: 500, slogan: 'Hansestadt-Tradition!', kellerPrice: 410, distance: '22 km von Bielefeld' }
];
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-sm opacity-80 mt-4">
              ${city.distance} - Schnell erreichbar aus der Bielefeld-Region
            </p>
          </div>
...
// Generate all Bielefeld region cities
bielefeldRegionCities.forEach(city => {
...
console.log(`Successfully generated ${bielefeldRegionCities.length} Bielefeld region city pages!`);