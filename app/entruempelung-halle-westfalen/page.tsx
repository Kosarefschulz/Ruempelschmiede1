    ...
    <>
        ...
        <div className="relative z-10 text-white px-4" style={{ height: 'clamp(400px, 70vh, 800px)', display: 'flex', alignItems: 'center' }}>
          <div className="text-center w-full">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6">
              Entrümpelung Halle (Westfalen) - Westfälisch gründlich!
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl mb-10 opacity-90 max-w-4xl mx-auto">
              ...
              in Halle (Westfalen) und Umgebung - Alles aus einer Hand mit Zufriedenheitsgarantie.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#2C4F5E] mb-4">
              Berechnen Sie Ihre Entrümpelungskosten in Halle (Westfalen) sofort!
            </h2>
            <p className="text-xl text-gray-600">
              Unser einzigartiger Kalkulator zeigt Ihnen in 2 Minuten, was Ihre Entrümpelung in Halle (Westfalen) kostet
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              ...
              <p className="text-3xl font-bold text-[#C73E3A] my-4">ab 675 €</p>
              <p className="text-gray-600 mb-6">für 1-Zimmer-Wohnung in Halle (Westfalen)</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              ...
              <p className="text-3xl font-bold text-[#C73E3A] my-4">ab 2010 €</p>
              <p className="text-gray-600 mb-6">für 1-Zimmer-Wohnung in Halle (Westfalen)</p>
              <ul className="text-left space-y-2 mb-6">
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-[#C73E3A] rounded-full mr-3 mt-1.5 flex-shrink-0"></span>
          ...
          <div className="text-center mt-8">
            <a href="/preise#kalkulator" className="text-[#2C4F5E] hover:text-[#1E3A47] font-semibold">
              Zum detaillierten Preisrechner für Halle (Westfalen) →
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#2C4F5E] mb-4">
              Ihre Entrümpelung in Halle (Westfalen) in sicheren Händen
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Seit über 8 Jahren sind wir der vertrauenswürdige Partner für Entrümpelungen in ganz Halle (Westfalen) 
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-16">
            ...
            <div className="text-center">
              <div className="text-5xl font-bold text-[#C73E3A] mb-2">400+</div>
              <p className="text-gray-600">Zufriedene Kunden in Halle (Westfalen)</p>
            </div>
            <div className="text-center">
          ...
          <div className="mb-16">
            <h3 className="text-3xl font-bold text-[#2C4F5E] text-center mb-4">
              So einfach funktioniert's in Halle (Westfalen)
            </h3>
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              In nur 4 einfachen Schritten zu Ihrer professionellen Entrümpelung in Halle (Westfalen) - 
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex-1">
                  <h4 className="text-xl font-bold text-[#2C4F5E] mb-3">Kostenlose Besichtigung in Halle (Westfalen)</h4>
                  <p className="text-gray-600">
                    Wir kommen zu Ihnen nach Halle (Westfalen), schauen uns alles an und erstellen ein unverbindliches Festpreis Angebot - 
                    natürlich kostenlos.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex-1">
                  ...
                  <p className="text-gray-600">
                    Sie erhalten ein detailliertes Festpreisangebot für Ihre Immobilie in Halle (Westfalen). Keine Überraschungen, 
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex-1">
                  ...
                  <p className="text-gray-600">
                    Unser erfahrenes Team in Halle (Westfalen) räumt schnell, sauber und zuverlässig. 
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex-1">
                  ...
                  <p className="text-gray-600">
                    Wir hinterlassen Ihre Wohnung in Halle (Westfalen) besenrein. Auf Wunsch übernehmen wir auch 
          ...
          <div className="bg-gradient-to-r from-[#2C4F5E] to-[#1E3A47] text-white rounded-2xl p-12 shadow-2xl">
            <h3 className="text-3xl font-bold mb-4 text-center">
              Warum über 400 Kunden in Halle (Westfalen) uns vertrauen
            </h3>
            <p className="text-center text-white/80 mb-12 max-w-2xl mx-auto">
              Ihre Zufriedenheit ist unser Antrieb. Deshalb garantieren wir höchste Standards bei jeder Entrümpelung in Halle (Westfalen).
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-white/20">
              <div className="grid md:grid-cols-3 gap-8 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">Anfahrtskosten in Halle (Westfalen)</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-[#F5F5F0]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#2C4F5E] mb-4">
              Unsere Entrümpelungs-Leistungen in Halle (Westfalen)
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Von der kleinen Kellerentrümpelung bis zur kompletten Entkernung - 
              wir bieten maßgeschneiderte Lösungen für jeden Bedarf in Halle (Westfalen).
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-64 bg-gray-200 relative overflow-hidden">
                <Image 
                  src="/Karton.png" 
                  alt="Haushaltsauflösung Halle (Westfalen)"
                  fill
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Komplette Wohnungsauflösungen in Halle (Westfalen) mit Wertanrechnung. Wir kümmern uns um alles - 
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-64 bg-gray-200 relative overflow-hidden">
                <Image 
                  src="/Gewerbe 2.jpg" 
                  alt="Gewerbeauflösung Halle (Westfalen)"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Büros, Praxen, Läden in Halle (Westfalen) - schnell und diskret. Auch am Wochenende und 
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-64 bg-gray-200 relative overflow-hidden">
                <Image 
                  src="/1-2.jpg" 
                  alt="Kellerentrümpelung Halle (Westfalen)"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Endlich wieder Platz im Keller in Halle (Westfalen)! Schnell und günstig - oft schon ab 405€. 
          ...
          <div className="text-center mt-12">
            <a href="/leistungen" className="inline-flex items-center bg-[#C73E3A] hover:bg-[#B02E2A] text-white px-8 py-4 rounded-lg font-semibold text-lg transform hover:scale-105 transition-all">
              Alle Leistungen für Halle (Westfalen) ansehen
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Entrümpelung im Großraum Halle (Westfalen)
            </h2>
            <p className="text-xl opacity-90 max-w-3xl mx-auto">
              Nicht nur in Halle (Westfalen), sondern auch in allen umliegenden Städten und Gemeinden 
              sind wir für Sie da! Professionelle Entrümpelung in der ganzen Region.
            </p>
            <p className="text-sm opacity-80 mt-4">
              12 km von Bielefeld - Schnell erreichbar aus der Bielefeld-Region
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm opacity-80 max-w-2xl mx-auto mb-6">
              Wir fahren im gesamten Großraum Halle (Westfalen) und in die angrenzenden Regionen. 
            ...
            <a href="/kontakt" className="inline-flex items-center bg-[#C73E3A] hover:bg-[#B02E2A] text-white px-8 py-3 rounded-lg font-semibold transition-all">
              Jetzt Anfrage für Halle (Westfalen) senden
              <span className="ml-2 text-lg">→</span>
            </a>
          </div>
        </div>
