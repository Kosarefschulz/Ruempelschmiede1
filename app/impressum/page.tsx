    ...
    <div className="py-16">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-blue-900 mb-8">Impressum</h1>
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <div>
              <h3 className="font-bold text-gray-800 mb-2">Registereintrag:</h3>
              <p>
            ...
            <div>
              ...
              <p>
                Michael Michalowski, Markus Knaub, Sergej Schulz<br />
                Waldbadstraße 9-13<br />
                33803 Steinhagen
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Zuständige Kammer: IHK Ostwestfalen zu Bielefeld<br />
