...
export const metadata: Metadata = {
  ...
  description: 'Entrümpelung in Höxter ✓ Festpreise ab 690€ ✓ 500+ zufriedene Kunden ✓ 24h Express-Service. Kostenlose Besichtigung!',
  keywords: 'Entrümpelung Höxter, Haushaltsauflösung Höxter, Wohnungsauflösung Höxter, Messie Entrümpelung Höxter, Kellerentrümpelung Höxter',
  openGraph: {
    title: 'Entrümpelung Höxter - Professionell & Günstig | Rümpel Schmiede',
    description: 'Entrümpelung in Höxter. Festpreise ab 690€. 24h Express-Service verfügbar.',
  ...
  twitter: {
    ...
    description: 'Professionelle Entrümpelung in Höxter. 24h Service.',
