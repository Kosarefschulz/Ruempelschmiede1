    ...
    <>
        ...
        <div className="relative z-10 text-white px-4" style={{ height: 'clamp(400px, 70vh, 800px)', display: 'flex', alignItems: 'center' }}>
          <div className="text-center w-full">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6">
              Entrümpelung Köln - Professionell und zuverlässig!
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl mb-10 opacity-90 max-w-4xl mx-auto">
              ...
              in Köln und Umgebung - Alles aus einer Hand mit Zufriedenheitsgarantie.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#2C4F5E] mb-4">
              Berechnen Sie Ihre Entrümpelungskosten in Köln sofort!
            </h2>
            <p className="text-xl text-gray-600">
              Unser einzigartiger Kalkulator zeigt Ihnen in 2 Minuten, was Ihre Entrümpelung in Köln kostet
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              ...
              <p className="text-3xl font-bold text-[#C73E3A] my-4">ab 720 €</p>
              <p className="text-gray-600 mb-6">für 1-Zimmer-Wohnung in Köln</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center border-2 border-[#2C4F5E]">
              ...
              <p className="text-3xl font-bold text-[#C73E3A] my-4">ab 1420 €</p>
              <p className="text-gray-600 mb-6">für 1-Zimmer-Wohnung in Köln</p>
              <ul className="text-left space-y-2 mb-6">
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-[#C73E3A] rounded-full mr-3 mt-1.5 flex-shrink-0"></span>
          ...
          <div className="text-center mt-8">
            <a href="/preise#kalkulator" className="text-[#2C4F5E] hover:text-[#1E3A47] font-semibold">
              Zum detaillierten Preisrechner für Köln →
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#2C4F5E] mb-4">
              Ihre Entrümpelung in Köln in sicheren Händen
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Seit über 8 Jahren sind wir der vertrauenswürdige Partner für Entrümpelungen in ganz Köln 
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-16">
            ...
            <div className="text-center">
              <div className="text-5xl font-bold text-[#C73E3A] mb-2">1800+</div>
              <p className="text-gray-600">Zufriedene Kunden in Köln</p>
            </div>
            <div className="text-center">
          ...
          <div className="mb-16">
            <h3 className="text-3xl font-bold text-[#2C4F5E] text-center mb-4">
              So einfach funktioniert's in Köln
            </h3>
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              In nur 4 einfachen Schritten zu Ihrer professionellen Entrümpelung in Köln - 
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex-1">
                  <h4 className="text-xl font-bold text-[#2C4F5E] mb-3">Kostenlose Besichtigung in Köln</h4>
                  <p className="text-gray-600">
                    Wir kommen zu Ihnen nach Köln, schauen uns alles an und erstellen ein unverbindliches Festpreis Angebot - 
                    natürlich kostenlos.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex-1">
                  ...
                  <p className="text-gray-600">
                    Sie erhalten ein detailliertes Festpreisangebot für Ihre Immobilie in Köln. Keine Überraschungen, 
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex-1">
                  ...
                  <p className="text-gray-600">
                    Unser erfahrenes Team in Köln räumt schnell, sauber und zuverlässig. 
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex-1">
                  ...
                  <p className="text-gray-600">
                    Wir hinterlassen Ihre Wohnung in Köln besenrein. Auf Wunsch übernehmen wir auch 
          ...
          <div className="bg-gradient-to-r from-[#2C4F5E] to-[#1E3A47] text-white rounded-2xl p-12 shadow-2xl">
            <h3 className="text-3xl font-bold mb-4 text-center">
              Warum über 1800 Kunden in Köln uns vertrauen
            </h3>
            <p className="text-center text-white/80 mb-12 max-w-2xl mx-auto">
              Ihre Zufriedenheit ist unser Antrieb. Deshalb garantieren wir höchste Standards bei jeder Entrümpelung in Köln.
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-white/20">
              <div className="grid md:grid-cols-3 gap-8 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">Anfahrtskosten in Köln</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#2C4F5E] mb-4">
              Ihre Vorteile bei Entrümpelung Köln
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Bei uns erhalten Sie sowohl eine professionelle Entrümpelung in Köln, 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-[#F5F5F0] rounded-xl p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[#2C4F5E] mb-2">Maximale Sicherheit in Köln</h3>
                  <p className="text-gray-600 text-sm">
                    Vollversichert und zertifiziert - Ihre Immobilie in Köln ist bei uns in professionellen Händen. 
            ...
            <div className="bg-[#F5F5F0] rounded-xl p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Unverbindliche Beratung vor Ort in Köln - völlig kostenfrei. Transparente Festpreise 
                    mit garantierter Kostensicherheit. Kostenfreie Anfahrt in ganz Köln.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#F5F5F0] rounded-xl p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[#2C4F5E] mb-2">Nachhaltige Entsorgung in Köln</h3>
                  <p className="text-gray-600 text-sm">
            ...
            <div className="bg-[#F5F5F0] rounded-xl p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[#2C4F5E] mb-2">Soziales Engagement in Köln</h3>
                  <p className="text-gray-600 text-sm">
                    Gut erhaltene Gegenstände spenden wir an lokale gemeinnützige Organisationen in Köln. 
            ...
            <div className="bg-[#F5F5F0] rounded-xl p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Geschultes Personal in Köln - ausschließlich eigene Mitarbeiter. Modernste Ausrüstung für effiziente Arbeit. 
          ...
          <div className="bg-gradient-to-r from-[#C73E3A] to-[#B02E2A] rounded-2xl p-8 text-white text-center">
            <h3 className="text-2xl font-bold mb-4">
              Überzeugt? Lassen Sie uns gemeinsam Ihr Projekt in Köln angehen!
            </h3>
            <p className="mb-6 opacity-90">
              Kostenlose Besichtigung • Unverbindliches Angebot • Günstige Festpreise für Köln
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <section className="py-16 bg-[#F5F5F0]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#2C4F5E] mb-4">
              Unsere Entrümpelungs-Leistungen in Köln
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Von der kleinen Kellerentrümpelung bis zur kompletten Entkernung - 
              wir bieten maßgeschneiderte Lösungen für jeden Bedarf in Köln.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Komplette Wohnungsauflösungen in Köln mit Wertanrechnung. Wir kümmern uns um alles - 
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Büros, Praxen, Läden in Köln - schnell und diskret. Auch am Wochenende und 
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-64 bg-gray-200 relative overflow-hidden">
                <Image 
                  ...
                  alt="Messie-Wohnung Entrümpelung Köln"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Sensible Räumung in Köln mit Desinfektion. Wir arbeiten diskret, respektvoll 
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Endlich wieder Platz im Keller in Köln! Schnell und günstig - oft schon ab 430€. 
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-64 bg-gray-200 relative overflow-hidden">
                <Image 
                  src="/Dachboden.jpg" 
                  alt="Dachbodenentrümpelung Köln"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Schwer zugängliche Dachböden in Köln? Kein Problem für unser erfahrenes Team! 
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-[#2C4F5E] mb-3">Express-Service Köln</h3>
                <p className="text-gray-700 mb-4">
                  Eilig? Innerhalb von 48 Stunden räumen wir in Köln für Sie - garantiert! 
          ...
          <div className="text-center mt-12">
            <a href="/leistungen" className="inline-flex items-center bg-[#C73E3A] hover:bg-[#B02E2A] text-white px-8 py-4 rounded-lg font-semibold text-lg transform hover:scale-105 transition-all">
              Alle Leistungen für Köln ansehen
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#2C4F5E] mb-4">
              Das sagen unsere Kunden in Köln
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Über 1800 zufriedene Kunden in ganz Köln - ihre Geschichten sprechen für sich
            </p>
          </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 px-4">
                  <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
                    ...
                    <p className="text-gray-700 mb-6 italic">
                      "Professionelle Entrümpelung in Köln. Das Team war pünktlich, freundlich und sehr gründlich."
                    </p>
                    <div className="border-t pt-4">
                      <p className="font-bold text-[#2C4F5E]">Familie Müller</p>
                      <p className="text-sm text-gray-600">Haushaltsauflösung Köln</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
                    ...
                    <p className="text-gray-700 mb-6 italic">
                      "Express-Service in Köln - innerhalb von 48 Stunden war alles erledigt. Top!"
                    </p>
                    <div className="border-t pt-4">
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <p className="text-sm text-gray-600">Wohnungsauflösung Köln</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="min-w-full">
                <div className="grid md:grid-cols-3 gap-8 px-4">
                  <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
                    ...
                    <p className="text-gray-700 mb-6 italic">
                      "Kellerentrümpelung in Köln - schnell und sauber. Der Festpreis wurde eingehalten."
                    </p>
                    <div className="border-t pt-4">
                      <p className="font-bold text-[#2C4F5E]">Familie Bauer</p>
                      <p className="text-sm text-gray-600">Keller Köln</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <p className="text-sm text-gray-600">Messie-Hilfe Köln</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <p className="text-sm text-gray-600">Büroauflösung Köln</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 px-4">
                  <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <p className="text-sm text-gray-600">Nachlassauflösung Köln</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <p className="text-sm text-gray-600">Dachboden Köln</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
                    ...
                    <p className="text-gray-700 mb-6 italic">
                      "Als Immobilienverwaltung sind wir sehr zufrieden. Zuverlässig und immer pünktlich in Köln."
                    </p>
                    <div className="border-t pt-4">
                      <p className="font-bold text-[#2C4F5E]">Immobilien Service GmbH</p>
                      <p className="text-sm text-gray-600">Mehrere Objekte Köln</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Entrümpelung im Großraum Köln
            </h2>
            <p className="text-xl opacity-90 max-w-3xl mx-auto">
              Nicht nur in Köln, sondern auch in allen umliegenden Städten und Gemeinden 
          ...
          <div className="text-center">
            ...
            <p className="text-sm opacity-80 max-w-2xl mx-auto mb-6">
              Wir fahren im gesamten Großraum Köln und in die angrenzenden Regionen. 
